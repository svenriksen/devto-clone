...
export default function Login() {
    ...
    return <div className="max-w-[640px] px-4 mx-auto flex flex-col items-center mt-12">
        ...
        <p className='mt-4 italic text-sm'>By signing in, you are agreeing to our privacy policy, terms of use and code of conduct.</p>
        <hr className='border-solid border-black border-t-[1px] mt-4 opacity-70 w-full'></hr>
        <p className='mt-4 text-sm'>New to DEV Community?  <Link href={"/signup"} className='text-blue-700'>Create account.</Link></p>
