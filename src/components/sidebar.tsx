...
-80 0 0 80 0 80 80 0 80 0 0 78 c0 43 3 82 7 86 4 4 39 5 78 4 l70 -3 3 -82z">
            ...
            <Link href={"/"}><li className='btn flex items-center'>
                <svg xmlns="http://www.w3.org/2000/svg" height={24} width={24} className='mr-2' version="1.1" viewBox="0 0 47.5 47.5" id="svg2"><defs id="defs6"><clipPath id="clipPath18"><path d="M 0,38 38,38 38,0 0,0 0,38 z" id="path20"></path></clipPath></defs><g transform="matrix(1.25,0,0,-1.25,0,47.5)" id="g12"><g id="g14"><g clip-path="url(#clipPath18)" id="g16"><g transform="translate(33,30)" id="g22">
                    ...
                    <g transform="translate(19,11)" id="g30">
                        <path d="m 0,0 c 0,-1.104 -0.896,-2 -2,-2 l -12,0 c -1.104,0 -2,0.896 -2,2 l 0,18 c 0,1.104 0.896,2 2,2 l 12,0 c 1.104,0 2,-0.896 2,-2 L 0,0 z" id="path32" style={{ fill: "#99aab5", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}></path></g><g transform="translate(19,11)" id="g34"><path d="m 0,0 c -0.999,1.998 -3.657,2 -4,2 -2,0 -5,-2 -8,-2 -1,0 -2,0.896 -2,2 l 0,16 c 0,1.104 1,2 2,2 3.255,0 6,2 8,2 3,0 4,-1.896 4,-3 L 0,0 z" id="path36" style={{ fill: "#e1e8ed", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}>
                        </path>
                    </g>
                    <g transform="translate(35,11)" id="g38">
                        <path d="m 0,0 c 0,-1.104 -0.896,-2 -2,-2 l -12,0 c -1.104,0 -2,0.896 -2,2 l 0,18 c 0,1.104 0.896,2 2,2 l 12,0 c 1.104,0 2,-0.896 2,-2 L 0,0 z" id="path40" style={{ fill: "#99aab5", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}>
                        </path>
                    </g>
                    <g transform="translate(19,11)" id="g42">
                        <path d="m 0,0 c 0.999,1.998 3.657,2 4,2 2,0 5,-2 8,-2 1,0 2,0.896 2,2 l 0,16 c 0,1.104 -1,2 -2,2 C 8.744,20 6,22 4,22 1,22 0,20.104 0,19 L 0,0 z" id="path44" style={{ fill: "#ccd6dd", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}>
                        </path>
                    </g>
                </g>
                </g>
            ...
            <Link href={"/"}><li className='btn flex items-center'>
                ...
                <span>Software comparisons</span></li >
            </Link>
        </ul >
