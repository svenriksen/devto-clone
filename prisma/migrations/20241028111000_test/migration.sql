...
CREATE TABLE "Reaction" (
    ...
    CONSTRAINT "Reaction_pkey" PRIMARY KEY ("createdById","postId")
);
...
CREATE TABLE "User" (
    ...
    "name" TEXT,
    "email" TEXT,
    "emailDisplay" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_subId_fkey" FOREIGN KEY ("subId") REFERENCES "Comment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
